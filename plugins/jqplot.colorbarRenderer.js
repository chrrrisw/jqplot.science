(function($) {
    ...
    function set_data(new_data, new_dims) {
        ...
        this.data = new_data;
        if (!this.dims.dx) {
            this.dims.dx = (this.dims.xmax - this.dims.xmin) / (this.dims.xdim - 1);
        }
        if (!this.dims.dy) {
            this.dims.dy = (this.dims.ymax - this.dims.ymin) / (this.dims.ydim - 1);
        }
        this.source_data = [];
